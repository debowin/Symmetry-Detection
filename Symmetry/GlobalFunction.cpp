...
void GlobalFun::computeKnnNeigbhors(vector<CVertex> &datapts, vector<CVertex> &querypts, int numKnn, bool need_self_included = false, string purpose = "?_?")
{
	...
	cout << endl;
	cout << "compute KNN Neighbors for: " << purpose << endl;
